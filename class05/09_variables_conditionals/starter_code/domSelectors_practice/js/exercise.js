 ...
 */
	...
	// function question3(){
	// 	$("li.falseFact").replaceWith("<li>True Fact</li>");
	// }
 ...
 */
 ...
 //Function 8 is selecting tags with the class "city". 
 //It is then adding an src atrribute of the following. So presumably it's adding a picture?
 // It added a picture. 
